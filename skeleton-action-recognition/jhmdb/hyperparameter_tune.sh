...
do
    ...
    do
        ...
        python skeleton_model.py --drive_dir /comm_dat/nfleece/JHMDB --learning_rate 0.01 --batch_size $batchsize --num_filters 128 --weight_decay $weightdecay --gpu 1 --version $1-0.01-128-$batchsize-$weightdecay &
        ...
        python skeleton_model.py --drive_dir /comm_dat/nfleece/JHMDB --learning_rate 0.01 --batch_size $batchsize --num_filters 512 --weight_decay $weightdecay --gpu 1 --version $1-0.01-512-$batchsize-$weightdecay &
