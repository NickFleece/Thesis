...
\usepackage{mathtools} % Use the Palatino font by default
...
\thesistitle{Efficient Intermediate Representations for Pose-Based Action Recognition} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\subject{Artificial Intelligence and Deep Learning} % Your subject area, this is not currently used anywhere in the template, print it elsewhere with \subjectname
