...
\begin{figure}[ht]
	\subfigure[N=1]{\includegraphics[width=8cm]{IntermediateSkip1}}
	\subfigure[N=2]{\includegraphics[width=8cm]{IntermediateSkip2}}
	\centering
	\caption{Two examples of temporal adjustment to the stacked representation. In both cases, the representation skips N frames in each step, meaning with a N value of 1 the representation will ignore every other frame, etc.}
