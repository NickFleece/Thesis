...
The advantage of this model is that it is highly efficient and lightweight, but does suffer from the issue of the global position of the person being crucial in how the model interprets the actions, as well as depending on things such as camera angles.
